...
const Login = () => {
    ...
    return (
            <form className="flex flex-col gap-4 bg-ui-surfaceContainer border-ui-outline rounded-xl border w-3/4 mx-auto p-6 md:p-12 md:w-2/4 lg:w-1/4">
            ...
            <button className="w-full cursor-pointer bg-ui-primary text-ui-insidePrimaryText font-semibold py-1 rounded flex justify-center items-center" type="button">{t("Sign in")}
                {
            ...
            <div className="flex w-full justify-center"> 
                <p className="text-ui-primaryText">{t("New user?")} <a className="text-ui-primary" href="/register">{t("Register now")}</a></p>
            </div>
            </form>
    );
}
